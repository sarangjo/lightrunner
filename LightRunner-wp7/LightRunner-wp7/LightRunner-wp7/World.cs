...
{
    /// <summary>
    /// The World class holds all of the players, enemies and environment objects. It handles collisions and drawing methods, as well as loading content.
    /// </summary>
    public class World
    {
        ...
        public World(bool isMenu)
        {
            ...
            for (int i = 0; i < level; i++)
                enemies.Add(new Enemy(new Vector2(r.Next(950) + 300,
                        r.Next(700)), 50, 50, level));
